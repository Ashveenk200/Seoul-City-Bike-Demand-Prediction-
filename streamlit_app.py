...
def main():
    ...
    if st.button("Predict Demand"):
        model_path = r'D:\0project\own project masti\short project\seoal bike demand prediction\rf_model.pkl'
        scaler_path = r'D:\0project\own project masti\short project\seoal bike demand prediction\sc_model.pkl'
